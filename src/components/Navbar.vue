...
<template>
	...
	<header
		...
		<nav class="relative container flex items-center justify-between gap-3 py-2 px-4 sm:px-6 lg:px-8">

			<a class="flex-none font-semibold text-xl text-black focus:outline-none focus:opacity-80 dark:text-white"
				href="#" aria-label="Brand">{{ config.app_name }}</a>
			...
			<div class="md:order-3 flex justify-end items-center gap-x-1">
				...
				<button type="button"
					...
					id="hs-header-base-collapse" aria-haspopup="dialog" aria-expanded="false"
					aria-controls="hs-header-base" aria-label="Toggle navigation" data-hs-overlay="#hs-header-base">
					Menu
